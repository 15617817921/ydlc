package jy_mxp.leon.priv.qdh_barcoder.sdl;

/**
 * Created by dantevsyou on 2017/11/13.
 */
...
//-----------------------------------------------------------
        ...
        import jy_mxp.leon.priv.qdh_barcoder.R;
        import jy_mxp.leon.priv.qdh_barcoder.adc.BarCodeReader;
        import jy_mxp.leon.priv.qdh_barcoder.utils.BeepUtil;
        ...
        SurfaceHolder.Callback, BarCodeReader.VideoCallback, BarCodeReader.ErrorCallback
{
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        Log.i("SDLguiActivity", "dispatchKeyEvent keycode: " + event.getKeyCode() + ", action: " + event.getAction());
