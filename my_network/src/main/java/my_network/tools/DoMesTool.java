...
public class DoMesTool {
    ...
    {
        try {
            MyLogger.kLog().e("count:"+count+"fitstMessage:"+firstMessage+"i"+i+"\n");
            /*
               向服务端写一次数据
             */
            ...
            MyLogger.kLog().e("doMes()从服务端度的数据"+receiveStr+"\n");
            /*
               进行迭代，直到不满足条件
             */
            ...
            e.printStackTrace();
            MyLogger.kLog().e("network"+e.toString()+"传输消息头或获取数据错误");
            MyLogger.kLog().e("doMes()"+"方法错误"+"\n");
        }
    }
}
