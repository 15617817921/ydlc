...
public class GvCbOtherAdapter extends CommonAdapter<CbMoreBean.Bean> {

    private List<CbMoreBean.Bean> list;

    public GvCbOtherAdapter(Context context, List<CbMoreBean.Bean> mDatas, int layoutId) {
    ...
    public interface OnCheckClickListener {
        void onCheckClick(String pfxx, int sorce, int position, String content);
    }
