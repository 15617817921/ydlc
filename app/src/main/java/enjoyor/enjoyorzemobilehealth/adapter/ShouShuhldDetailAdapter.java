...
public class ShouShuhldDetailAdapter extends BaseAdapter{
    private final Context context;
    private final List<ShuHouLD> data;
    private final LayoutInflater inflater;

    public ShouShuhldDetailAdapter(Context context, List<ShuHouLD> data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ShuHouLD bean=data.get(position);
