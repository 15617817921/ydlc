...
public class XunHuiJLAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vHolder.tv_xhjl_name_item=(TextView)convertView.findViewById(R.id.tv_xhjl_name_item);
        ...
        vHolder.tv_xhjl_name_item.setText(xhjl.getXingMing());
        return convertView;
    }
