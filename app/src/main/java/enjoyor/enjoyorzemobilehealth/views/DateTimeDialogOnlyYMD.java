...
public class DateTimeDialogOnlyYMD extends AlertDialog implements View.OnClickListener {
    ...
    protected DateTimeDialogOnlyYMD(Context context, String trim, View.OnClickListener onClickListener, boolean isDayVisible, boolean isMonthVisible, boolean isYearVisible) {
        super(context);
    }
...
//        Log.i("testss", this.measureWidth + "measuredWidth");
    ...
    private void onOkButtonClick() {
        ...
        Log.e("testss", mDatePicker.getYear() + "====" + (mDatePicker.getMonth() + 1) + "==" + mDatePicker.getDayOfMonth());
    }
