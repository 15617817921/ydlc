...
public class CreateXmlUtil {
    ...
    public static String createXueTangCheckXml(ShuXueHuLiJLD shuXueHuLiJLD,String tableName){
        String xmlResult = null;
        StringWriter xmlWriter = new StringWriter();
        XmlSerializer xmlSerializer = Xml.newSerializer();
        try {
            ...
            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "riqi");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getRiqi())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getRiqi());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "zaocanq");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getZaocanq())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getZaocanq());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "zaocanqqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getZaocanqqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getZaocanqqm());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "zaocanh");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getZaocanh())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getZaocanh());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "zaocanhqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getZaocanhqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getZaocanhqm());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wucanq");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWucanq())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWucanq());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wucanqqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWucanqqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWucanqqm());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wucanh");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWucanh())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWucanh());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wucanhqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWucanhqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWucanhqm());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wancanq");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWancanq())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWancanq());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wancanqqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWancanqqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWancanqqm());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wancanh");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWancanh())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWancanh());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wancanhqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWancanhqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWancanhqm());
            }
            xmlSerializer.endTag("", "DC");


            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "shuiqian");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getShuiqian())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getShuiqian());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "shuiqianqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getShuiqianqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getShuiqianqm());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wanjian");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWanjian())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWanjian());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "wanjianqm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getWanjianqm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getWanjianqm());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "beizhu");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getBeizhu())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getBeizhu());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "id");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getId())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getId());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "bingrenzyid");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getBingrenzyid())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getBingrenzyid());
            }
            xmlSerializer.endTag("", "DC");

            xmlSerializer.startTag("", "DC");
            xmlSerializer.attribute("", "Name", "bingqudm");
            if(TextUtils.isEmpty(shuXueHuLiJLD.getBingqudm())){
                xmlSerializer.text("");
            }else {
                xmlSerializer.text(shuXueHuLiJLD.getBingqudm());
            }
            xmlSerializer.endTag("", "DC");
