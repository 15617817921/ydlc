...
import enjoyor.enjoyorzemobilehealth.activity.BrxxActivity;
...
import enjoyor.enjoyorzemobilehealth.activity.SscxActivity;
...
public class BrlbActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        zhierCall = (new ZhierCall())
                ...
                .setCanshu(canshu)
                .setContext(this)
                .setPort(5000).setDialogmes("获取病人信息...")
                .build();
...
//                        Toast.makeText(BrlbActivity.this, openItem.getTitle(), Toast.LENGTH_SHORT).show();
                        intent = new Intent(BrlbActivity.this, TemperatureChartActivity.class);
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        intent = new Intent(BrlbActivity.this, BryzBbenActivity.class);
                        ...
                        intent.putExtra("brid", listBRLB.get(position).getBINGRENID());
                        startActivity(intent);
                        ...
                        break;
                    case 3:
                        intent = new Intent(BrlbActivity.this, BrxxcxActivity.class);
                        MyApplication.getInstance().setOther_brlb(listBRLB.get(position));
                        intent.putExtra("ccc", listBRLB.get(position).getXINGMING());
                        startActivity(intent);
                        finish();
                        break;
                }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                MyApplication.getInstance().setChoosebr(position);// = position;
                if (x != null) {
                    switch (x) {
                        case "1":
                        ...
                        case "2":
                            ...
                            intent1.putExtra("brid", listBRLB.get(position).getBINGRENID());
...
//                            finish();
                            ...
                            intent55.putExtra("XINGMING", listBRLB.get(position).getXINGMING());
                            intent55.putExtra("XINGBIE", listBRLB.get(position).getXINGBIE());
                            intent55.putExtra("BINGRENID", listBRLB.get(position).getBINGRENID());
                            startActivity(intent55);
                            finish();
                            break;
                        case "6":
...
//                            startActivity(intent3);
                        ...
                        case "SsHuLiDan":
                            ...
                            MyApplication.getInstance().setOther_brlb(null);
                            MyApplication.getInstance().setOther_brlb(listBRLB.get(position));
                            Intent intent11 = new Intent(BrlbActivity.this, SsHuLiDanActivity.class);
                            intent11.putExtra("BINGRENZYID", listBRLB.get(position).getBINGRENZYID());
                            intent11.putExtra("CHUANGHAO", listBRLB.get(position).getCHUANGWEIHAO());
                            intent11.putExtra("XINGMING", listBRLB.get(position).getXINGMING());
                            intent11.putExtra("XINGBIE", listBRLB.get(position).getXINGBIE());
                        ...
                        case "YcPingGuDan":
                            MyApplication.getInstance().setOther_brlb(null);
                            MyApplication.getInstance().setOther_brlb(listBRLB.get(position));
                            Intent intent12 = new Intent(BrlbActivity.this, YcPingGuDanActivity.class);
                            intent12.putExtra("BINGRENZYID", listBRLB.get(position).getBINGRENZYID());
                            intent12.putExtra("CHUANGHAO", listBRLB.get(position).getCHUANGWEIHAO());
                            intent12.putExtra("XINGMING", listBRLB.get(position).getXINGMING());
                            intent12.putExtra("XINGBIE", listBRLB.get(position).getXINGBIE());
                            startActivity(intent12);
                            finish();
                            break;

                        case "XTJC":
                            Intent intentXTJC = new Intent();
                            intentXTJC.putExtra("position", position);
                            setResult(RESULT_OK, intentXTJC);
                            finish();
                            break;

                        case "HeDui":
                            Intent intentHeDui = new Intent();
                            intentHeDui.putExtra("position", position);
                            setResult(RESULT_OK, intentHeDui);
                            finish();
                            break;
                        case "sxbbcj":
                            Intent intentHeDui2 = new Intent(BrlbActivity.this, SxbbcjActivity.class);
                            intentHeDui2.putExtra("position", position);
                            startActivity(intentHeDui2);
                            finish();
                            break;
                        case "sd":
                            Intent intentHeDui3 = new Intent(BrlbActivity.this, SxsdActivity.class);
                            intentHeDui3.putExtra("position", position);
                            startActivity(intentHeDui3);
                            finish();
                            break;
                        case "sxq":
                            Intent intentHeDui4 = new Intent(BrlbActivity.this, SxqhdActivity.class);
                            intentHeDui4.putExtra("position", position);
                            startActivity(intentHeDui4);
                            finish();
                            break;
    ...
    private void init() {
        ...
        tvTitleInclude.setText("病人列表");


        intent = getIntent();
        //第一次由登录页面跳转的
        isbacks = intent.getBooleanExtra("isback", false);
        log.e("状态" + isbacks);
    }
    ...
    MyXmlHandler xmlHandler = new MyXmlHandler(this, this) {
        ...
        public void handlerMessage(Message msg) {
            switch (msg.what) {
                case END:
                    tvTitleInclude.setText("病人列表（" + listBRLB.size() + "人）");
...
//                                    break;
//                                case "I级护理":
//                                    viewHolder.setText(R.id.huli, "一级护理");
//                                    break;
//                                case "II级护理":
//                                    viewHolder.setText(R.id.huli, "二级护理");
//                                    break;
//                                case "III级护理":
//                                    viewHolder.setText(R.id.huli, "三级护理");
//                                    break;
//                            }
