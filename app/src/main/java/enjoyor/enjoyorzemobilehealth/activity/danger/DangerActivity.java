...
public class DangerActivity extends BaseActivity implements View.OnClickListener,ScanFactory.FragScan {
...
//    private String pgrname;
    ...
    private DangerActivity.DoDecodeThread mDoDecodeThread;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //扫码相关
        mDoDecodeThread = new DangerActivity.DoDecodeThread();
...
//		}
    ...
    private void init() {
        ...
        int choosebr = app.getChoosebr();
        List<BRLB> listBRLB = app.getListBRLB();
        ...
        try {
            if (tag.equals("bingrenlist")) {
                ...
                BRLB brlb = listBRLB.get(choosebr);
...
//                        freshPage(mPosition);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            startActivity(new Intent(DangerActivity.this, HomePageActivity.class));
            finish();
            return true;
        }

//        if (android.os.Build.MODEL.equals("m80")||android.os.Build.MODEL.equals("m80s")) {
//            if (scanInf.onKeyDown(keyCode, event, DangerActivity.this.getClass().getName())) {
//
//                return true;
//
//            }
...
//            checkAndChangePatient(MyApplication.getInstance().getListBRLB().get(0).getBINGRENZYID());
            ...
            playFailBeepSound();
            Toast.makeText(DangerActivity.this, "请扫描正确的病人腕带条码!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void checkAndChangePatient(String zyid) {
        ...
        if(isContain){
            ...
            Toast.makeText(DangerActivity.this, "病人切换成功!", Toast.LENGTH_SHORT).show();
        }else {
            playFailBeepSound();
            Toast.makeText(DangerActivity.this,"匹配不成功",Toast.LENGTH_SHORT).show();
        }
    }
