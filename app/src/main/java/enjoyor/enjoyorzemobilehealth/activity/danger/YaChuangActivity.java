...
public class YaChuangActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] endNames = new String[]{"A.保持皮肤清洁", "B.翻身+皮肤检查", "C.气垫床", "D.敷料"};
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.sj:
                ...
                //时间选择器
                TimePickerView pvTime = new TimePickerView.Builder(YaChuangActivity.this, new TimePickerView.OnTimeSelectListener() {
                    @Override
